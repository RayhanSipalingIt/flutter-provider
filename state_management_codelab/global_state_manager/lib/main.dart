  ...
  //supaya tidak mines
   void decrementCounter(int index) {
    if (index >= 0 && index < counters.length && counters[index] > 0) {
      ...
      counters[index] = 0; // Set nilai counter menjadi 0 jika mencoba mengurangkan dari 0 atau indeks tidak valid
    }
  }
}
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        body: CounterWidget(globalState), // Gunakan CounterWidget di sini
      ),
    );
  }
}
